...
data = readData()
if ( time.time() - data.get("startAt") ) < 3 * 60 + 30:
  print "not taken 3min: %s" % ( startAt )
  os.sys.exit(0)
...
def clickSendHero():
  return click( "templates/send_hero_button.png" ,True )

def detectFlightDestination():
  return detect( "templates/20min.png" )

def click3min():
  click( "templates/3min.png" )
