<?PHP
$g = new Growl( "192.168.0.5" , "00suga" , "growl_notify" );
//$g->register();
$result = $g->notify("My Alert", "New Website Visitor", "Here's the body text");
echo $result ? "o" : "x" ;
    class Growl
    {
        ...
        public function notify($name, $title, $message, $priority = 1, $sticky = true )
        {
