...
, DOWNLOAD_MODE:          [3,'gDLMD','',0,0,'Normal link','Link with title']
...
gvar.hasGradient   =!(gvar.isOpera || (getValue('USE_IMAGE_FOR_BUTTON')>0));
}
ViewingPageCheck();
...
if(m[1]==download_fmt) { video_url=m[2]+'&title='+el.getAttribute('title'); break; }
if(isDefined(m[3])) { fmt_url_map=m[3]; } else { break; }
}
}
if(!video_url) { video_url=window.location.protocol+'//'+window.location.host+'/get_video?t='+t_id+'&video_id='+video_id+url_fmt(download_fmt); }
}
}
if(fail_js>'') {
...
var fum=flashvars.match(/(?:^|\&)fmt_url_map\=([^(\&|$)]*)/i);
if(fum) { return decodeURIComponent(fum[1]); }
return '';
}
...
download_url_fmt(newElement2td2A,t_id,video_id,get_fmt_url_map(flashvars),download_fmt);
...
+'[dir="rtl"] .comment-author { margin-left:100%; margin-right:-6px; padding-bottom:1px; } [dir="rtl"] .wrapper { position:relative; padding-right:10px !important; padding-bottom:2px !important; }'
...
GM_addGlobalStyle('.yt-uix-button { background:#B0C0D0 url('+YT_MASTER_IMG+') repeat-x center -1602px; border-color:#C4C4D4; }'
+'.yt-uix-button:hover { background:#E0E0F0 url('+YT_MASTER_IMG+') repeat-x center -1802px; !important; box-shadow:0 0 3px #AAC !important;-moz-box-shadow:0 0 3px #AAC !important;-webkit-box-shadow:0 0 3px #AAC !important; }'
+'.yt-uix-pager-selected,.yt-uix-pager-selected:hover { background:#DDDDDD !important; box-shadow:none !important;-moz-box-shadow:none !important;-webkit-box-shadow:none !important; } .yt-uix-pager { margin-top:2px; margin-bottom:2px; }'
+'#subscribeDiv, #unsubscribeDiv, #editSubscriptionDiv { margin-right:2px; margin-left:2px; background:#fed81c url('+YT_MASTER_IMG+') repeat-x center -2202px;color:#992222 !important;border-color:#ecc101; } #subscribeDiv:hover, #unsubscribeDiv:hover, #editSubscriptionDiv:hover { background-position:center -2394px !important; background-color:#FFFFBB !important; box-shadow:0 0 3px #CB0 !important;-moz-box-shadow:0 0 3px #CB0 !important;-webkit-box-shadow:0 0 3px #CB0 !important; }'
);
}
}
}
...
if(!gvar.hasGradient) { GM_addGlobalStyle('a.yte-button-blue { background:#c6d7f3 url('+YT_MASTER_IMG+') repeat-x center -1602px !important; } a.yte-button-blue:hover { background:#c6d7f3 url('+YT_MASTER_IMG+') repeat-x center -1802px !important; }'); }
